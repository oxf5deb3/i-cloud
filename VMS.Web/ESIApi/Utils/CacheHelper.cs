...
namespace VMS.ESIApi.Utils
{
    public class CacheHelper
    {
        ...
        public static void SlideInsert(string key,object obj,TimeSpan slidingExpiration)
        {
            if (obj != null)
            {
                _cache.Insert(key, obj, null, Cache.NoAbsoluteExpiration, slidingExpiration);
            }
        }
        /// <summary>
        /// 把对象加到缓存,并把过期时间设为最大值
