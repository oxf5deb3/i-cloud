...
go
--拖车表
if not exists(select * from sysobjects where xtype='U' and id=OBJECT_ID('t_trailer'))
CREATE TABLE [dbo].[t_trailer](
	[trailer_no] [int] IDENTITY(1,1) NOT NULL,
	[trailer_date] [nvarchar](50) NULL,
	[trailer_number] [nvarchar](50) NULL,
	[trailer_totalmotorcycle] [nvarchar](50) NULL,
	[trailer_tricycle] [nvarchar](50) NULL,
	[trailer_batterymotorcycle] [nvarchar](50) NULL,
	[trailer_totalvehicle] [nvarchar](50) NULL,
	[trailer_bigcar] [nvarchar](50) NULL,
	[trailer_smallcar] [nvarchar](50) NULL,
	[trailer_tractor] [nvarchar](50) NULL,
	[trailer_totaltrailer] [nvarchar](50) NULL,
...
--20200324
--违章类型
if not exists(select * from sysobjects where xtype='U' and id=OBJECT_ID('t_bd_breakrules_type'))
create table t_bd_breakrules_type
(
  id decimal(16,0) identity(1,1) primary key,
  name nvarchar(40) null,
  punish_desc varchar(100) null,--处罚描述
  memo varchar(500) null,
  oper_id varchar(10) not null,
  oper_date datetime not null default(getdate())
)
go
--违章信息
if not exists(select * from sysobjects where xtype='U' and id=OBJECT_ID('t_bd_breakrules'))
create table t_bd_breakrules
(
  id decimal(16,0) identity(1,1) primary key,
  name nvarchar(8) null,
  sex char(1) not null default('0'),--0:男 1:女
  age int null,
  phone varchar(20) null,
  id_card varchar(30) null,--身份证
  car_no varchar(30) null,--车牌号
  driver_no varchar(50) null,
  driving_no varchar(50),--行驶证
